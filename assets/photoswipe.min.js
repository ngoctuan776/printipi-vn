...
class y {
    ...
    o(t) {
        const {
            pswp: i
        } = this.slide, s = this.slide["x" === t ? "width" : "height"] * this.currZoomLevel, h = _("x" === t ? "left" : "top", i.options, i.viewportSize, this.slide.data, this.slide.index), e = this.slide.panAreaSize[t];
...
class x {
    ...
    P(t) {
        const {
            ...
            pan: e,
            bounds: o
        } = s, r = e[t], a = i.bgOpacity < 1 && "y" === t, c = r + function(t, i) {
            return t * i / (1 - i)
        }(h[t], .995);
        if (a) {
            const t = this.S(r),
...
class z {
    ...
    change() {
        const {
            ...
            currSlide: o
        } = n, r = o.zoomLevels.min, a = o.zoomLevels.max;
...
class E {
    ...
    easeFrame(t, i) {
        ...
        if (1 === this.St) s = this.velocity + this.xt * t, h = (t + s * i) * e, this.velocity = h * -this.xt + s * e;
        else if (this.St < 1) {
...
function X(t, i, s) {
    ...
    const {
        options: e
    } = i, n = v(e, i.viewportSize || g(e, i), t, s), o = new b(e, t, -1);
...
class Y {
    ...
    removeByIndex(t) {
        const i = this.It.findIndex((i => i.index === t)); - 1 !== i && this.It.splice(i, 1)
    }
    getContentByIndex(t) {
